...
function Project(){
    ...
    <div class="experience-details-container">
      <div class="about-containers project-container">
        <Container src="./assets/nike-1.webp" alt="Project 1" h2="The Nike-Store" githubLink="https://github.com/Sarthakyadav98/nike-app" liveDemoLink="https://nike-studio.netlify.app/" imgHeight="300px" />
